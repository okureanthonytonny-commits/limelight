...
import { useCart } from '../context/CartContext'; // Updated path to new context location
...
function NavigationBar() {
  ...
  const { cartCount } = useCart(); // Using the new cart context
          ...
          >
            ...
            <Offcanvas.Body>
              ...
              <Nav.Link
                ...
                onClick={handleClose}
                className={location.pathname.includes('/products') || location.pathname.includes('/product') ? 'fw-bold text-primary' : ''}
              >
                Shop
              </Nav.Link>
              </Nav>
